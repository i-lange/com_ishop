...
namespace Ilange\Component\Ishop\Administrator\View\Group;
...
/**
 * Класс представления для группы характеристик
 * @since 1.0.0
 */
class HtmlView extends FormView
{
    ...
    public function __construct(array $config)
    {
        ...
        $config['help_link']      = 'Group:_Edit';
        $config['toolbar_icon']   = 'pencil-alt group-add';
    ...
    protected function addToolbar()
    {
        ...
        $this->toolbarTitle = Text::_('COM_ISHOP_' . ($checkedOut ? 'VIEW' : ($isNew ? 'ADD' : 'EDIT')) . '_GROUP');
    ...
    protected function addModalToolbar()
    {
        ...
        ToolbarHelper::title(
            Text::_('COM_ISHOP_' . ($checkedOut ? 'VIEW' : ($isNew ? 'ADD' : 'EDIT') . '_GROUP')),
