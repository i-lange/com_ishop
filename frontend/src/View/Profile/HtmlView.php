...
namespace Ilange\Component\Ishop\Site\View\Profile;
...
class HtmlView extends BaseHtmlView
{
    ...
    /**
     * Объект списка заказов пользователя
     * @var object
     * @since 1.0.0
     */
    public $orders;
    ...
    protected function _prepareDocument()
    {
        ...
        if ($active) {
            ...
            $menu_title   = $title = Text::_('COM_ISHOP_PROFILE');
        }
