...
/**
 * Класс контроллера для способа оплаты
 * @since 1.0.0
 */
class PaymentController extends FormController
{
    ...
    {
        $this->checkToken();
        $model = $this->getModel('Payment', 'Administrator', []);
        $this->setRedirect(Route::_('index.php?option=com_ishop&view=payments' . $this->getRedirectToListAppend(), false));
