...
class PaymentModel extends AdminModel
{
     ...
     * @since 1.0.0
     */
    public $typeAlias = 'com_ishop.payment';
     ...
     * @since  1.0.0
     */
    protected $associationsContext = 'com_ishop.payment';
    ...
    protected function canDelete($record)
    {
        ...
        return $this->getCurrentUser()->authorise('core.delete', 'com_ishop.payment.' . (int)$record->id);
    }
    ...
    protected function canEditState($record)
    {
        ...
        if (!empty($record->id)) {
            return $user->authorise('core.edit.state', 'com_ishop.payment.' . (int)$record->id);
        }
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        $id         = (int)$this->getState('payment.id', $IdFromInput);
        $record->id = $id;
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_ishop.edit.payment.data', []);
        ...
        if (empty($data)) {
            ...
            if ($this->getState('payment.id') == 0) {
                $filters = (array)$app->getUserState('com_ishop.payment.filter');
        ...
        $this->preprocessData('com_ishop.payment', $data);
     ...
     * @since 1.0.0
     */
    public function getTable($name = 'Payment', $prefix = '', $options = [])
    {
