...
class PaymentsModel extends ListModel
{
    ...
    protected function getListQuery()
    {
        ...
        $query
            ...
            ->from($db->quoteName('#__ishop_payments', 'a'))
            ->join('LEFT',
            ...
            $subQuery = $db->getQuery(true)
                ...
                ->where(
                    [
                        ...
                        $db->quoteName('asso1.context') . ' = ' . $db->quote('com_ishop.payment'),
                    ]
                );
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item) {
            $item->typeAlias = 'com_ishop.payments';
        }
