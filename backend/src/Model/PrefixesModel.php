 ...
 * @since 1.0.0
 */
class PrefixesModel extends ListModel
{
    /**
     * Конструктор
    ...
    protected function getListQuery()
    {
        ...
        $query
            ...
            ->from($db->quoteName('#__ishop_prefixes', 'a'))
            ->join('LEFT',
            ...
            $subQuery = $db->getQuery(true)
                ...
                ->where(
                    [
                        ...
                        $db->quoteName('asso1.context') . ' = ' . $db->quote('com_ishop.prefix'),
                    ]
                );
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item) {
            $item->typeAlias = 'com_ishop.prefixes';
        }
