...
/**
 * Класс контроллера списка префиксов
 * @since 1.0.0
 */
class PrefixesController extends AdminController
{
    /**
     * Конструктор
     *
     ...
     * @since 1.0.0
     */
    public function getModel($name = 'Prefix', $prefix = 'Administrator', $config = ['ignore_request' => true]): object
    {
