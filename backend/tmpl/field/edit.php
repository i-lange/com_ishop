...
/** @var Ilange\Component\Ishop\Administrator\View\Field\HtmlView $this */
...
<form action="<?php echo Route::_('index.php?option=com_ishop&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>"
      ...
      name="adminForm"
      id="item-form"
      aria-label="<?php echo Text::_('COM_ISHOP_' . ((int) $this->item->id === 0 ? 'ADD' : 'EDIT') . '_FIELD', true); ?>"
      class="form-validate">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <fieldset id="fieldset-options" class="options-form">
                    ...
                    <div><?php echo $this->form->renderField('icon'); ?></div>
                    <div><?php echo $this->form->renderField('color'); ?></div>
                    <div><?php echo $this->form->renderField('unit'); ?></div>
                </fieldset>
            </div>
        </div>
        <?php echo HTMLHelper::_('uitab.endTab'); ?>
