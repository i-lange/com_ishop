...
class ManufacturersModel extends ListModel
{
    ...
    protected function getListQuery()
    {
        ...
        $query
            ...
            ->from($db->quoteName('#__ishop_manufacturers', 'a'))
            ->join('LEFT',
            ...
            $subQuery = $db->getQuery(true)
                ...
                ->where(
                    [
                        ...
                        $db->quoteName('asso1.context') . ' = ' . $db->quote('com_ishop.manufacturer'),
                    ]
                );
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item) {
            $item->typeAlias = 'com_ishop.manufacturer';
