...
namespace Ilange\Component\Ishop\Administrator\View\Payment;
...
/**
 * Класс представления для способа оплаты
 * @since 1.0.0
 */
class HtmlView extends FormView
{
    ...
    public function __construct(array $config)
    {
        ...
        $config['help_link']      = 'Payment:_Edit';
        $config['toolbar_icon']   = 'pencil-alt payment-add';
    ...
    protected function initializeView()
    {
        ...
        $this->canDo = ContentHelper::getActions('com_ishop', 'payment', $this->item->id);
    ...
    protected function addToolbar()
    {
        ...
        $this->toolbarTitle = Text::_('COM_ISHOP_' . ($checkedOut ? 'VIEW' : ($isNew ? 'ADD' : 'EDIT')) . '_PAYMENT');
    ...
    protected function addModalToolbar()
    {
        ...
        ToolbarHelper::title(
            Text::_('COM_ISHOP_' . ($checkedOut ? 'VIEW' : ($isNew ? 'ADD' : 'EDIT') . '_PAYMENT')),
            'pencil-alt payment-add'
        );
