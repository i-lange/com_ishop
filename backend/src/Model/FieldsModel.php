...
class FieldsModel extends ListModel
{
    ...
    protected function getListQuery()
    {
            ...
            $subQuery = $db->getQuery(true)
                ...
                ->where(
                    [
                        ...
                        $db->quoteName('asso1.context') . ' = ' . $db->quote('com_ishop.field'),
                    ]
                );
        ...
        // Фильтрация по типу характеристики
        ...
        if (is_numeric($type)) {
            ...
            $type = ArrayHelper::toInteger($type);
            $query->whereIn($db->quoteName('a.type'), $type);
        }
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item) {
            $item->typeAlias = 'com_ishop.field';
        }
