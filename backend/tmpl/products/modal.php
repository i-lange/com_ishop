...
<div class="container-popup">
    <form action="<?php echo Route::_('index.php?option=com_ishop&view=products&layout=modal&tmpl=component&' . Session::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm">
