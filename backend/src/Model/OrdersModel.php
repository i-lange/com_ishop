...
class OrdersModel extends ListModel
{
    ...
    protected function getListQuery()
    {
        ...
        $query
            ->select(
                $this->getState('list.select',
                    [
                        ...
                        $db->quoteName('a.ishop_user_id'),
                        $db->quoteName('a.products'),
                        $db->quoteName('a.discounts'),
                        $db->quoteName('a.payment'),
            ...
            ->from($db->quoteName('#__ishop_orders', 'a'))
            ->join('LEFT',
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item) {
            $item->typeAlias = 'com_ishop.order';
        }
