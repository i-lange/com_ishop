...
namespace Ilange\Component\Ishop\Administrator\View\Payments;

defined('_JEXEC') or die;

use Ilange\Component\Ishop\Administrator\Extension\IshopComponent;
use Ilange\Component\Ishop\Administrator\Model\PaymentsModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        $canDo	 = ContentHelper::getActions('com_ishop', 'payment');
        $user    = $this->getCurrentUser();
        $toolbar = $this->getDocument()->getToolbar();

        // Заголовок страницы
        ToolbarHelper::title(Text::_('COM_ISHOP_PAYMENTS'), 'fa fa-cubes');
        ...
        if (!$this->isEmptyState) {
            ...
            if ($canDo->get('core.edit.state')) {
                ...
                $childBar->checkin('payments.checkin');
        ...
        // Ссылка на список оплат частями
        $toolbar
            ->linkButton('parts', 'COM_ISHOP_PAYMENTS_PARTS')
            ->url('index.php?option=com_ishop&view=parts')
            ->icon('icon-eye');
