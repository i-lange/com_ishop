...
class PartModel extends AdminModel
{
     ...
     * @since 1.0.0
     */
    public $typeAlias = 'com_ishop.part';
    ...
    protected function canDelete($record)
    {
        ...
        return $this->getCurrentUser()->authorise('core.delete', 'com_ishop.part.' . (int)$record->id);
    }
    ...
    protected function canEditState($record)
    {
        ...
        if (!empty($record->id)) {
            return $user->authorise('core.edit.state', 'com_ishop.part.' . (int)$record->id);
        }
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        $id         = (int)$this->getState('part.id', $IdFromInput);
        $record->id = $id;
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_ishop.edit.part.data', []);
        ...
        if (empty($data)) {
            ...
            if ($this->getState('part.id') == 0) {
                $filters = (array)$app->getUserState('com_ishop.part.filter');
        ...
        $this->preprocessData('com_ishop.part', $data);
     ...
     * @since 1.0.0
     */
    public function getTable($name = 'Part', $prefix = '', $options = [])
    {
