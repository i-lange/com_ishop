...
namespace Ilange\Component\Ishop\Administrator\View\Field;
...
/**
 * Класс представления для характеристики
 * @since 1.0.0
 */
class HtmlView extends FormView
{
    ...
    public function __construct(array $config)
    {
        ...
        $config['help_link']      = 'Field:_Edit';
        $config['toolbar_icon']   = 'pencil-alt field-add';
    ...
    protected function initializeView()
    {
        ...
        $this->canDo = ContentHelper::getActions('com_ishop', 'field', $this->item->id);
    ...
    protected function addToolbar()
    {
        ...
        $this->toolbarTitle = Text::_('COM_ISHOP_' . ($checkedOut ? 'VIEW' : ($isNew ? 'ADD' : 'EDIT')) . '_FIELD');
    ...
    protected function addModalToolbar()
    {
        ...
        ToolbarHelper::title(
            Text::_('COM_ISHOP_' . ($checkedOut ? 'VIEW' : ($isNew ? 'ADD' : 'EDIT') . '_FIELD')),
            'pencil-alt field-add'
        );
