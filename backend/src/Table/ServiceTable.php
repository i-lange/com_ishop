...
class ServiceTable extends Table
{
	...
	{
        $this->typeAlias = 'com_ishop.service';
		parent::__construct('#__ishop_services', 'id', $db, $dispatcher);
    ...
    public function check()
    {
        ...
        // Проверяем заголовок
        if (trim($this->title) == '') {
            throw new InvalidArgumentException('Не указан заголовок сервисного центра');
        }
