...
/**
 * Модель списка способов доставки
 * @since 1.0.0
 */
class DeliveriesModel extends ListModel
{
    ...
    protected function getListQuery()
    {
        ...
        $query
            ...
            ->from($db->quoteName('#__ishop_deliveries', 'a'))
            ->join('LEFT',
            ...
            $subQuery = $db->getQuery(true)
                ...
                ->where(
                    [
                        ...
                        $db->quoteName('asso1.context') . ' = ' . $db->quote('com_ishop.delivery'),
                    ]
                );
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item) {
            $item->typeAlias = 'com_ishop.deliveries';
        }
