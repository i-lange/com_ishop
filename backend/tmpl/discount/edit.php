...
/** @var Ilange\Component\Ishop\Administrator\View\Discount\HtmlView $this */
...
<form action="<?php echo Route::_('index.php?option=com_ishop&layout=edit' . $tmpl . '&id=' . (int) $this->item->id); ?>"
      ...
      name="adminForm"
      id="item-form"
      aria-label="<?php echo Text::_('COM_ISHOP_' . ((int) $this->item->id === 0 ? 'ADD' : 'EDIT') . '_DISCOUNT', true); ?>"
      class="form-validate">
            ...
            <div class="col-lg-3">
                ...
                <fieldset id="fieldset-options" class="options-form">
                    ...
                    <div>
                        ...
                        <?php echo $this->form->renderField('suppliers'); ?>
                        <?php echo $this->form->renderField('min_price'); ?>
                        <?php echo $this->form->renderField('min_amount'); ?>
                    </div>
                </fieldset>
            </div>
        </div>
