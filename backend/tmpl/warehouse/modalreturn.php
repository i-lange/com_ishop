...
/** @var Ilange\Component\Ishop\Administrator\View\Warehouse\HtmlView $this */

$icon     = 'icon-check';
$title    = $this->item ? $this->item->title : '';
$content  = $this->item ? $this->item->alias : '';
$data     = ['contentType' => 'com_ishop.warehouse'];

if ($this->item) {
    $data['id']    = $this->item->id;
    $data['title'] = $this->item->title;
    $data['uri']   = RouteHelper::getWarehouseRoute($this->item->id, $this->item->language);
}
