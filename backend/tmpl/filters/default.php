...
/** @var Ilange\Component\Ishop\Administrator\View\Filters\HtmlView $this */
...
$userId = $user->id;
$canManage = $user->authorise('core.manage', 'com_ishop');
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_ishop&task=filters.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}
?>
<form action="<?php echo Route::_('index.php?option=com_ishop&view=filters'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table itemList" id="filtersList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_ISHOP_FILTERS'); ?>,
                        ...
                        ?>
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="1">
                                <td class="text-center">
                                    <?php echo HTMLHelper::_('grid.id', $i, $item->id, false, 'cid', 'cb', $item->category_title); ?>
                                </td>
                                ...
                                <td class="article-status text-center">
                                    <?php
                                    echo (new PublishedButton())->render((int) $item->state, $i, [
                                        'task_prefix' => 'filters.',
                                        'disabled' => !$canChange,
                                        'id' => 'state-' . $item->id,
                                    ]);
                                ...
                                <th scope="row" class="has-context">
                                    <div class="break-word">
                                        ...
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_ishop&task=filter.edit&id=' . $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->category_title); ?>">
