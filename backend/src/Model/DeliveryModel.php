 ...
 * @since 1.0.0
 */
class DeliveryModel extends AdminModel
{
    /**
     ...
     * @since 1.0.0
     */
    public $typeAlias = 'com_ishop.delivery';
     ...
     * @since  1.0.0
     */
    protected $associationsContext = 'com_ishop.delivery';
    ...
    protected function canDelete($record)
    {
        ...
        return $this->getCurrentUser()->authorise('core.delete', 'com_ishop.delivery.' . (int)$record->id);
    }
    ...
    protected function canEditState($record)
    {
        ...
        if (!empty($record->id)) {
            return $user->authorise('core.edit.state', 'com_ishop.delivery.' . (int)$record->id);
        }
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        $id         = (int)$this->getState('delivery.id', $IdFromInput);
        $record->id = $id;
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_ishop.edit.delivery.data', []);
        ...
        if (empty($data)) {
            ...
            if ($this->getState('delivery.id') == 0) {
                $filters = (array)$app->getUserState('com_ishop.delivery.filter');
        ...
        $this->preprocessData('com_ishop.delivery', $data);
     ...
     * @since 1.0.0
     */
    public function getTable($name = 'Delivery', $prefix = '', $options = [])
    {
