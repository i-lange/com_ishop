...
/** @var Ilange\Component\Ishop\Administrator\View\Manufacturers\HtmlView $this */
...
$userId    = $user->id;
$canManage = $user->authorise('manufacturers.manage', 'com_ishop');
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_ishop&task=manufacturers.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}

$assoc = Associations::isEnabled();
?>
<form action="<?php echo Route::_('index.php?option=com_ishop&view=manufacturers'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <?php else : ?>
                    <table class="table itemList" id="manufacturerList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_ISHOP_MANUFACTURERS'); ?>,
                                ...
                                <th scope="row" class="has-context">
                                    <div class="break-word">
                                        <?php if ($item->checked_out) : ?>
                                            <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'manufacturers.', $canCheckin); ?>
                                        <?php endif; ?>
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_ishop&task=manufacturer.edit&id=' . $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
