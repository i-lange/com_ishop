...
class ManufacturersField extends ListField
{
	...
	protected function getOptions()
	{
        ...
        /*$options[] = (object) [
            'value'    => '',
            'text'     => Text::_('COM_ISHOP_FIELD_MANUFACTURER'),
            'selected' => $this->value === 0,
            'checked'  => $this->value === 0,
        ];*/

        return array_merge(parent::getOptions(), $options, ProductHelper::manufacturerOptions($language));
	}
