...
/**
 * Класс поля Поставщик
 * @since 1.0.0
 */
class SuppliersField extends ListField
{
    /**
     * Тип поля формы
     * @var		string
    ...
    protected function getOptions()
    {
        ...
        /*$options[] = (object) [
            'value'    => '',
            'text'     => Text::_('COM_ISHOP_FIELD_SUPPLIER'),
            'selected' => $this->value === 0,
            'checked'  => $this->value === 0,
        ];*/

        return array_merge(parent::getOptions(), $options, ProductHelper::supplierOptions($language));
    }
