...
class OrderTable extends Table
{
	...
	{
        $this->typeAlias = 'com_ishop.order';
		parent::__construct('#__ishop_orders', 'id', $db, $dispatcher);
    ...
    public function check()
    {
        ...
        if (!$this->ishop_user_id) {
            $this->ishop_user_id = 0;
        }
        ...
        if (!$this->id) {
            ...
            // Скидки по умолчанию пустая строка json
            if (!isset($this->discounts)) {
                $this->discounts = '{}';
            }

            // Оплата по умолчанию пустая строка json
            if (!isset($this->payment)) {
                $this->payment = '{}';
            }

            // Доставка по умолчанию пустая строка json
