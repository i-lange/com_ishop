...
class ServiceModel extends AdminModel
{
     ...
     * @since 1.0.0
     */
    public $typeAlias = 'com_ishop.service';
     ...
     * @since  1.0.0
     */
    protected $associationsContext = 'com_ishop.service';
    ...
    protected function canDelete($record)
    {
        ...
        return $this->getCurrentUser()->authorise('core.delete', 'com_ishop.service.' . (int)$record->id);
    }
    ...
    protected function canEditState($record)
    {
        ...
        if (!empty($record->id)) {
            return $user->authorise('core.edit.state', 'com_ishop.service.' . (int)$record->id);
        }
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        // получаем идентификатор из состояния service.id,
        // при сохранении используем данные из input
        $id         = (int)$this->getState('service.id', $IdFromInput);
        $record->id = $id;
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_ishop.edit.service.data', []);
        ...
        if (empty($data)) {
            ...
            if ($this->getState('service.id') == 0) {
                $filters = (array)$app->getUserState('com_ishop.service.filter');
        ...
        $this->preprocessData('com_ishop.service', $data);
     ...
     * @since 1.0.0
     */
    public function getTable($name = 'Service', $prefix = '', $options = [])
    {
