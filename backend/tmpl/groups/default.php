...
/** @var Ilange\Component\Ishop\Administrator\View\Groups\HtmlView $this */
...
$userId    = $user->id;
$canManage = $user->authorise('groups.manage', 'com_ishop');
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_ishop&task=groups.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}

$assoc = Associations::isEnabled();
?>
<form action="<?php echo Route::_('index.php?option=com_ishop&view=groups'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table itemList" id="groupList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_ISHOP_GROUPS'); ?>,
                                ...
                                <th scope="row" class="has-context">
                                    <div class="break-word">
                                        ...
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_ishop&task=group.edit&id=' . $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
