...
/**
 * Класс контроллера оплаты частями
 * @since 1.0.0
 */
class PartController extends FormController
{
    ...
    {
        $this->checkToken();
        $model = $this->getModel('Part', 'Administrator', []);
        $this->setRedirect(Route::_('index.php?option=com_ishop&view=parts' . $this->getRedirectToListAppend(), false));
