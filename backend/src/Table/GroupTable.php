...
class GroupTable extends Table
{
	...
	{
        $this->typeAlias = 'com_ishop.group';
		parent::__construct('#__ishop_groups', 'id', $db);
	}
    ...
    public function check()
    {
        ...
        // Проверяем заголовок
        if (trim($this->title) == '') {
            throw new InvalidArgumentException('Не указан заголовок группы');
        }
