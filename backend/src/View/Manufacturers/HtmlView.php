...
namespace Ilange\Component\Ishop\Administrator\View\Manufacturers;

defined('_JEXEC') or die;

use Ilange\Component\Ishop\Administrator\Extension\IshopComponent;
use Ilange\Component\Ishop\Administrator\Model\ManufacturersModel;
...
/**
 * Класс отображения списка производителей
 * @since 1.0.0
 */
class HtmlView extends BaseHtmlView
{
    ...
    {
        $canDo	 = ContentHelper::getActions('com_ishop', 'manufacturer');
        $user    = $this->getCurrentUser();
        $toolbar = $this->getDocument()->getToolbar();

        // Заголовок страницы
        ToolbarHelper::title(Text::_('COM_ISHOP_MANUFACTURERS'), 'fa fa-cubes');
        ...
        if (!$this->isEmptyState) {
            ...
            if ($canDo->get('core.edit.state')) {
                ...
                $childBar->checkin('manufacturers.checkin');
