...
/** @var Ilange\Component\Ishop\Administrator\View\Manufacturer\HtmlView $this */
...
<form action="<?php echo Route::_('index.php?option=com_ishop&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>"
      ...
      name="adminForm"
      id="item-form"
      aria-label="<?php echo Text::_('COM_ISHOP_' . ((int) $this->item->id === 0 ? 'ADD' : 'EDIT') . '_MANUFACTURER', true); ?>"
      class="form-validate">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <fieldset id="fieldset-image-export" class="options-form">
                    ...
                    <div>
                        <?php echo $this->form->renderFieldset('image-export'); ?>
                    </div>
                </fieldset>
            </div>
            <div class="col-12">
                <fieldset id="fieldset-image-more" class="options-form">
                    ...
                    <div>
                        <?php echo $this->form->renderFieldset('image-more'); ?>
                    </div>
                </fieldset>
            </div>
            <div class="col-12">
