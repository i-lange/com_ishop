...
<form action="<?php echo Route::_('index.php?option=com_ishop&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>"
      ...
      name="adminForm"
      id="item-form"
      aria-label="<?php echo Text::_('COM_ISHOP_' . ((int) $this->item->id === 0 ? 'ADD' : 'EDIT') . '_PREFIX', true); ?>"
      class="form-validate">
            ...
            <div class="col-lg-6">
                ...
                <fieldset id="fieldset-options" class="options-form">
                    ...
                    <div>
                        ...
                        <?php echo $this->form->renderField('nominative_sin'); ?>
                        <?php echo $this->form->renderField('nominative_plu'); ?>
                        <?php echo $this->form->renderField('genitive_sin'); ?>
                        <?php echo $this->form->renderField('genitive_plu'); ?>
                        <?php echo $this->form->renderField('accusative_sin'); ?>
                        <?php echo $this->form->renderField('accusative_plu'); ?>
                    </div>
                </fieldset>
            </div>
        </div>
