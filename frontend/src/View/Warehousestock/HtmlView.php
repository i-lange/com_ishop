...
namespace Ilange\Component\Ishop\Site\View\Warehousestock;
...
/**
 * HTML представление остатков на складе
 * @since 1.0.0
 */
class HtmlView extends BaseHtmlView
{
    ...
    protected function _prepareDocument()
    {
        ...
        if ($active) {
            ...
            $menu_title   = $title = Text::_('COM_ISHOP_WAREHOUSE_STOCK');
        }
