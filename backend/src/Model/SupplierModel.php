...
class SupplierModel extends AdminModel
{
     ...
     * @since 1.0.0
     */
    public $typeAlias = 'com_ishop.supplier';
     ...
     * @since  1.0.0
     */
    protected $associationsContext = 'com_ishop.supplier';
    ...
    protected function canDelete($record)
    {
        ...
        return $this->getCurrentUser()->authorise('core.delete', 'com_ishop.supplier.' . (int)$record->id);
    }
    ...
    protected function canEditState($record)
    {
        ...
        if (!empty($record->id)) {
            return $user->authorise('core.edit.state', 'com_ishop.supplier.' . (int)$record->id);
        }
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        // При редактировании поставщика
        // получаем идентификатор из состояния supplier.id,
        // при сохранении используем данные из input
        $id         = (int)$this->getState('supplier.id', $IdFromInput);
        $record->id = $id;
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_ishop.edit.supplier.data', []);
        ...
        if (empty($data)) {
            ...
            if ($this->getState('supplier.id') == 0) {
                $filters = (array)$app->getUserState('com_ishop.supplier.filter');
        ...
        $this->preprocessData('com_ishop.supplier', $data);
     ...
     * @since 1.0.0
     */
    public function getTable($name = 'Supplier', $prefix = '', $options = [])
    {
