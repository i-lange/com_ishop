...
/** @var Ilange\Component\Ishop\Administrator\View\Part\HtmlView $this */
...
<form action="<?php echo Route::_('index.php?option=com_ishop&layout=edit' . $tmpl . '&id=' . (int) $this->item->id); ?>"
      ...
      name="adminForm"
      id="item-form"
      aria-label="<?php echo Text::_('COM_ISHOP_' . ((int) $this->item->id === 0 ? 'ADD' : 'EDIT') . '_PART', true); ?>"
      class="form-validate">
    ...
    <div class="main-card">
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'options', Text::_('COM_ISHOP_FIELD_PARAMS_PART')); ?>
        <div>
            <fieldset id="fieldset-attribs" class="options-form">
                <legend><?php echo Text::_('COM_ISHOP_FIELD_PARAMS_PART'); ?></legend>
