...
namespace Ilange\Component\Ishop\Site\View\Warehouse;

defined('_JEXEC') or die;

use Ilange\Component\Ishop\Site\Model\WarehouseModel;
use Joomla\CMS\Factory;
use Joomla\CMS\MVC\View\HtmlView as BaseHtmlView;
use Joomla\CMS\Language\Text;

/**
 * HTML представление страницы склада/магазина
 * @since 1.0.0
 */
class HtmlView extends BaseHtmlView
{
    /**
     * Объект склада/магазина
     * @var object
     * @since 1.0.0
     */
    protected $item;
    ...
    protected function _prepareDocument()
    {
        ...
        if ($active) {
            ...
            $menu_title   = $title = Text::_('COM_ISHOP_WAREHOUSE');
        }
