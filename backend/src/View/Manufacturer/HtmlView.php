...
namespace Ilange\Component\Ishop\Administrator\View\Manufacturer;
...
/**
 * Класс представления для производителя
 * @since 1.0.0
 */
class HtmlView extends FormView
{
    ...
    public function __construct(array $config)
    {
        ...
        $config['help_link']      = 'Manufacturer:_Edit';
        $config['toolbar_icon']   = 'pencil-alt manufacturer-add';
    ...
    protected function addToolbar()
    {
        ...
        $this->toolbarTitle = Text::_('COM_ISHOP_' . ($checkedOut ? 'VIEW' : ($isNew ? 'ADD' : 'EDIT')) . '_MANUFACTURER');
    ...
    protected function addModalToolbar()
    {
        ...
        ToolbarHelper::title(
            Text::_('COM_ISHOP_' . ($checkedOut ? 'VIEW' : ($isNew ? 'ADD' : 'EDIT') . '_MANUFACTURER')),
            'pencil-alt manufacturer-add'
        );
        ...
        if ($canCreate || $canEdit) {
            ...
            $toolbar->save('manufacturer.save');
        }

        $toolbar->cancel('manufacturer.cancel');
    }
}
