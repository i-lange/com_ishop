...
/** @var Ilange\Component\Ishop\Administrator\View\Parts\HtmlView $this */
...
$userId    = $user->id;
$canManage = $user->authorise('parts.manage', 'com_ishop');
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_ishop&task=parts.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}

$assoc = Associations::isEnabled();
?>
<form action="<?php echo Route::_('index.php?option=com_ishop&view=parts'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table itemList" id="partsList">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="w-20">
                                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_ISHOP_FIELD_CREDIT_TYPE', 'a.type', $listDirn, $listOrder); ?>
                                </th>
                        ...
                        ?>
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="1">
                                ...
                                <th scope="row" class="has-context">
                                    <div class="break-word">
                                        <?php if ($item->checked_out) : ?>
                                            <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'parts.', $canCheckin); ?>
                                        <?php endif; ?>
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_ishop&task=part.edit&id=' . $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
                                ...
                                <td class=""><?php echo Text::_('COM_ISHOP_FIELD_CREDIT_TYPE_' . $item->type); ?></td>
