...
class GroupModel extends AdminModel
{
     ...
     * @since 1.0.0
     */
    public $typeAlias = 'com_ishop.group';
     ...
     * @since  1.0.0
     */
    protected $associationsContext = 'com_ishop.group';
    ...
    protected function canDelete($record)
    {
        ...
        return $this->getCurrentUser()->authorise('core.delete', 'com_ishop.group.' . (int)$record->id);
    }
    ...
    protected function canEditState($record)
    {
        ...
        if (!empty($record->id)) {
            return $user->authorise('core.edit.state', 'com_ishop.group.' . (int)$record->id);
        }
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_ishop.edit.group.data', []);
        ...
        if (empty($data)) {
            ...
            if ($this->getState('field.id') == 0) {
                $filters = (array)$app->getUserState('com_ishop.group.filter');
        ...
        $this->preprocessData('com_ishop.group', $data);
     ...
     * @since 1.0.0
     */
    public function getTable($name = 'Group', $prefix = '', $options = [])
    {
