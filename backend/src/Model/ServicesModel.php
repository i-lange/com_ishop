...
/**
 * Модель списка сервисных центров
 * @since 1.0.0
 */
class ServicesModel extends ListModel
{
    ...
    protected function getListQuery()
    {
        ...
        $query
            ...
            ->from($db->quoteName('#__ishop_services', 'a'))
            ->join('LEFT',
            ...
            $subQuery = $db->getQuery(true)
                ...
                ->where(
                    [
                        ...
                        $db->quoteName('asso1.context') . ' = ' . $db->quote('com_ishop.service'),
                    ]
                );
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item) {
            $item->typeAlias = 'com_ishop.service';
