...
(
    ...
    `wb_id`            varchar(20)                                              NOT NULL DEFAULT ''     COMMENT 'Идентификатор карточки Wildberries',
    `ozon_id`          varchar(20)                                              NOT NULL DEFAULT ''     COMMENT 'Идентификатор карточки Ozon',
...
(
    ...
    `compare`          tinyint                                                  NOT NULL DEFAULT 0          COMMENT 'Метод сравнения, -1 - меньше лучше, 0 - не влияет, 1 - больше лучше',
...
(
    ...
    `icon`             varchar(25)                                              NOT NULL DEFAULT ''         COMMENT 'Имя иконки',
    `weight`           int                                                      NOT NULL DEFAULT 0          COMMENT 'Вес значения для сравнения',
...
--
-- Структура таблицы `#__ishop_filters`
-- здесь хранятся настройки SEO-страниц результатов фильтрации товаров
--
...
CREATE TABLE IF NOT EXISTS `#__ishop_filters` (
    ...
    `warehouses`       text                                                   NOT NULL                    COMMENT 'JSON список складов',
    `ishop_fields`     mediumtext                                             NOT NULL                    COMMENT 'JSON набор характеристик и значений',
    `min_price`        int unsigned                                           NOT NULL DEFAULT 0          COMMENT 'Минимальная цена',
    `max_price`        int unsigned                                           NOT NULL DEFAULT 0          COMMENT 'Максимальная цена',
    `good_price`       tinyint unsigned                                       NOT NULL DEFAULT 0          COMMENT 'Только товары со скидкой',
    ...
    `link_anchor`      varchar(255)                                           NOT NULL DEFAULT ''         COMMENT 'Короткий анкор ссылки',
