...
/**
 * Класс контроллера для сервисного центра
 * @since 1.0.0
 */
class ServiceController extends FormController
{
    ...
    {
        $this->checkToken();
        $model = $this->getModel('Service', 'Administrator', []);
        $this->setRedirect(Route::_('index.php?option=com_ishop&view=services' . $this->getRedirectToListAppend(), false));
