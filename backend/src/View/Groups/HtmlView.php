...
namespace Ilange\Component\Ishop\Administrator\View\Groups;

defined('_JEXEC') or die;

use Ilange\Component\Ishop\Administrator\Extension\IshopComponent;
use Ilange\Component\Ishop\Administrator\Model\GroupsModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        $canDo	 = ContentHelper::getActions('com_ishop', 'group');
        $user    = $this->getCurrentUser();
        $toolbar = $this->getDocument()->getToolbar();

        // Заголовок страницы
        ToolbarHelper::title(Text::_('COM_ISHOP_GROUPS'), 'fa fa-cubes');
