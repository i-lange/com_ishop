...
namespace Ilange\Component\Ishop\Site\View\Warehouses;

defined('_JEXEC') or die;

use Ilange\Component\Ishop\Site\Model\WarehousesModel;
...
/**
 * HTML представление списка магазинов и ПВЗ
 * @since 1.0.0
 */
class HtmlView extends BaseHtmlView
{
    ...
    protected function _prepareDocument()
    {
        ...
        if ($active) {
            ...
            $menu_title   = $title = Text::_('COM_ISHOP_WAREHOUSES');
        }
