...
namespace Ilange\Component\Ishop\Administrator\View\Suppliers;

defined('_JEXEC') or die;

use Ilange\Component\Ishop\Administrator\Extension\IshopComponent;
use Ilange\Component\Ishop\Administrator\Model\SuppliersModel;
...
/**
 * Класс отображения списка поставщиков
 * @since 1.0.0
 */
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        // Заголовок страницы
        ToolbarHelper::title(Text::_('COM_ISHOP_SUPPLIERS'), 'fa fa-cubes');
        ...
        if (!$this->isEmptyState) {
            ...
            if ($this->state->get('filter.published') == IshopComponent::CONDITION_TRASHED &&
                ...
                $toolbar->delete('suppliers.delete')
