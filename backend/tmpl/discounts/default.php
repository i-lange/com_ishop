...
/** @var Ilange\Component\Ishop\Administrator\View\Discounts\HtmlView $this */
...
$userId    = $user->id;
$canManage = $user->authorise('discounts.manage', 'com_ishop');
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_ishop&task=discounts.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}

$assoc = Associations::isEnabled();
?>
<form action="<?php echo Route::_('index.php?option=com_ishop&view=discounts'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table itemList" id="discountsList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_ISHOP_DISCOUNTS'); ?>,
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="w-1 text-center">
                                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_ISHOP_FIELD_PROMO_CODE', 'a.code', $listDirn, $listOrder); ?>
                                </th>
                                <th scope="col" class="w-1 text-center">
                                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_ISHOP_FIELD_PERCENT', 'a.percent', $listDirn, $listOrder); ?>
                                </th>
                                ...
                                <th scope="row" class="has-context">
                                    <div class="break-word">
                                        <?php if ($item->checked_out) : ?>
                                            <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'discounts.', $canCheckin); ?>
                                        <?php endif; ?>
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_ishop&task=discount.edit&id=' . $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
                                        ...
                                        <div class="small fw-bold">
                                            <?php if ($item->type === 1) : ?>
                                                <?php echo Text::_('COM_ISHOP_FIELD_TYPE_REAL'); ?>
                                            <?php elseif ($item->type === 0) : ?>
                                                <?php echo Text::_('COM_ISHOP_FIELD_TYPE_PSEUDO'); ?>
                                            <?php else: ?>
                                                <?php echo Text::_('COM_ISHOP_FIELD_TYPE_CODE'); ?>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </th>
