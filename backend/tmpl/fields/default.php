...
/** @var Ilange\Component\Ishop\Administrator\View\Fields\HtmlView $this */
...
$userId    = $user->id;
$canManage = $user->authorise('fields.manage', 'com_ishop');
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_ishop&task=fields.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}

$assoc = Associations::isEnabled();
?>
<form action="<?php echo Route::_('index.php?option=com_ishop&view=fields'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <?php else : ?>
                    <table class="table itemList" id="manufacturerList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_ISHOP_FIELDS'); ?>,
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="w-10 d-none d-md-table-cell">
                                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_ISHOP_FIELD_TYPE', 'a.type', $listDirn, $listOrder); ?>
                                </th>
                                <th scope="col" class="w-10 d-none d-md-table-cell">
                                    <?php echo Text::_('COM_ISHOP_FIELD_VALUES'); ?>
                                </th>
                                <th scope="col" class="w-10 d-none d-md-table-cell">
                                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_ISHOP_FIELD_UNIT', 'a.unit', $listDirn, $listOrder); ?>
                                </th>
                                <th scope="col" class="w-10 d-none d-md-table-cell">
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="1">
                                ...
                                <th scope="row" class="has-context">
                                    <div class="break-word">
                                        ...
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_ishop&task=field.edit&id=' . $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
                                ...
                                <td class="small d-none d-md-table-cell">
                                    <?php
                                        switch ($item->type) {
                                            case 0:
                                                echo Text::_('COM_ISHOP_FIELD_INT');
                                                break;
                                            case 1:
                                                echo Text::_('COM_ISHOP_FIELD_LIST');
                                                break;
                                            case 2:
                                                echo Text::_('COM_ISHOP_FIELD_BOOL');
                                                break;
                                        }
                                    ?>
                                </td>
                                <td class="small d-none d-md-table-cell">
                                    <?php echo $item->field_values; ?>
                                </td>
                                <td class="small d-none d-md-table-cell">
