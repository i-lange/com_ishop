...
/**
 * Класс контроллера для поставщика
 * @since 1.0.0
 */
class SupplierController extends FormController
{
    ...
    {
        $this->checkToken();
        $model = $this->getModel('Supplier', 'Administrator', []);
        $this->setRedirect(Route::_('index.php?option=com_ishop&view=suppliers' . $this->getRedirectToListAppend(), false));
