...
class SupplierTable extends Table
{
	...
	{
        $this->typeAlias = 'com_ishop.supplier';
		parent::__construct('#__ishop_suppliers', 'id', $db, $dispatcher);
    ...
    public function check()
    {
        ...
        // Проверяем заголовок
        if (trim($this->title) == '') {
            throw new InvalidArgumentException('Не указан заголовок поставщика');
        }
