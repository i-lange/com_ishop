...
/**
 * Модель карты значений характеристик
 * @since 1.0.0
 */
class MapModel extends AdminModel
{
     ...
     * @since 1.0.0
     */
    public $typeAlias = 'com_ishop.map';
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_ishop.edit.map.data', []);
        ...
        $this->preprocessData('com_ishop.map', $data);
     ...
     * @since 1.0.0
     */
    public function getTable($name = 'Map', $prefix = '', $options = [])
    {
