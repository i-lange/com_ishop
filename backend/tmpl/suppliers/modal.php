...
<div class="container-popup">
    <form action="<?php echo Route::_('index.php?option=com_ishop&view=suppliers&layout=modal&tmpl=component&' . Session::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <?php else : ?>
            <table class="table table-sm">
                ...
                <?php foreach ($this->items as $i => $item) : ?>
                    ...
                    $link     = RouteHelper::getSupplierRoute($item->id, $item->language);
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <th scope="row">
                            <?php $attribs = 'data-content-select data-content-type="com_ishop.supplier"'
                                . ' data-id="' . $item->id . '"'
